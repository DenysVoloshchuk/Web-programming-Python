...
from wtforms import StringField, SubmitField, SelectField, TextAreaField, BooleanField, ValidationError, PasswordField
...
class RegistrationForm(FlaskForm):
    username = StringField("Username",
                           validators=[DataRequired(),
                                       Length(
                                           min=4, max=20, message='Name length must be between %(min)d and %(max)d'),
